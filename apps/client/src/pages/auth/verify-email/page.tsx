...
import { Alert, AlertDescription, AlertTitle, Button } from "@apitool/ui";
...
export const VerifyEmailPage = () => {
  ...
  return (
    <div className="space-y-6">
      <Helmet>
        <title>
          {t`Verify your email address`} - {t`APITool`}
        </title>
      </Helmet>
      ...
      <div className="space-y-2">
        ...
        <p className="leading-relaxed opacity-75">
          <Trans>
            You should have received an email from <strong>APITool</strong> with a link to
            verify your account.
          </Trans>
        </p>
      </div>
